...
//            System.out.println("--------------------------------------\n");
    ...
    /**
     * Operation 4 support:
     * Run the trading pattern using any given portfolio
     * and return the final total portfolio value (cash + shares).
     */
    public static double runUserTradingPattern(Portfolio portfolio) {
        ...
        if (DEBUG) {
            System.out.println("==== FINAL RESULTS (runUserTradingPattern) ====");
            System.out.println("Final Cash: " + finalCash);
            System.out.println("Final Shares Value: " + finalSharesValue);
            System.out.println("Final Total Portfolio Value: " + finalTotal);
            System.out.println("Initial Investment: " + initial);
            System.out.println("Total Return %: " + (finalTotal / initial * 100.0));
        }
     ...
     * Runs the same simulation using the dummy portfolio and returns total value.
     */
    public static double runUserTradingPatternWithDummy() {
        Portfolio dummyPortfolio = initializeDummyPortfolio();
        return runUserTradingPattern(dummyPortfolio);
    }
